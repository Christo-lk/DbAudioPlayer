    ...
    <>
      <div className="  h-auto bg-blue-400 flex items-center flex-row sticky pt-1 pb-3 pl-1 ">
        <div className="flex flex-row">
          ...
          <div onClick={() => store.dispatch(setTrackListSource('QUEUED_TRACKS'))} className="ml-5 h-5 w-14 bg-yellow-400 mr-4">
            <button className={trackListSource === 'QUEUED_TRACKS' ? 'ml-1 mt-1 text-2xl leading-tight font-bold text-white' : 'ml-1 mt-1 text-2xl leading-tight font-bold  text-black hover:text-white'}>Queue:</button>
          </div>
